<script lang="ts">
    ...
    researchDate = new Date(data.researchSeminar.researchSeminarData[0].research_date);;
	...
	let obj = {
        research_seminar_id :  data.researchSeminar.researchSeminarData[0].id,
		nmims_school: data.researchSeminar.researchSeminarData[0].nmims_school != null ?  data.researchSeminar.researchSeminarData[0].nmims_school.map((dt: any) => {
						return { value: dt, label: dt };
					}) : null,
		nmims_campus: data.researchSeminar.researchSeminarData[0].nmims_campus != null ?  data.researchSeminar.researchSeminarData[0].nmims_campus.map((dt: any) => {
						return { value: dt, label: dt };
					}) : null,
		topic: data.researchSeminar.researchSeminarData[0].topic,
		nmims_authors: data.researchSeminar.researchSeminarData[0].nmims_authors != null ?  data.researchSeminar.researchSeminarData[0].nmims_authors.map((dt: any) => {
						return { value: dt.id, label: dt.name };
					}) : null,
		journal_name: data.researchSeminar.researchSeminarData[0].journal_name,
		uid: data.researchSeminar.researchSeminarData[0].uid,
		publisher:  data.researchSeminar.researchSeminarData[0].publisher,
		resource_person:  data.researchSeminar.researchSeminarData[0].resource_person,
		volume_no: data.researchSeminar.researchSeminarData[0].volume_no,
		issn_no:  data.researchSeminar.researchSeminarData[0].issn_no,
        doi_no : data.researchSeminar.researchSeminarData[0].doi_no,
		scopus_site_score: data.researchSeminar.researchSeminarData[0].scopus_site_score,
		impact_factor: data.researchSeminar.researchSeminarData[0].impact_factor !=0 ? data.researchSeminar.researchSeminarData[0].impact_factor : null ,
		paper_title: data.researchSeminar.researchSeminarData[0].paper_title,
		gs_indexed: data.researchSeminar.researchSeminarData[0].gs_indexed,
		wos_indexed: data.researchSeminar.researchSeminarData[0].wos_indexed,
		abdc_indexed: data.researchSeminar.researchSeminarData[0].abdc_indexed.length > 0 ? {
		...
		ugc_indexed: data.researchSeminar.researchSeminarData[0].ugc_indexed,
		scs_indexed: data.researchSeminar.researchSeminarData[0].scs_indexed,
		publisher_category: data.researchSeminar.researchSeminarData[0].publisher_category != null ? Number( data.researchSeminar.researchSeminarData[0].publisher_category) : null
	};
...
<Card {title}>
	...
	<div class="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
				...
				{:else}
					<button class="lms-primary-btn mt-2"
					on:click={downLoadFiles}	><i class="fa-solid fa-download text-md"></i></button
					>
				{/if}
			</div>		</div>
