...
getCampus,
    ...
    let facultyDetails = data.ResearchProjectDataList.ResearchProjectDataList[0].faculty_details || [];
    ...
    console.log('data.ResearchProjectDataList.iprdata[0].research_project_id ==>>', data.ResearchProjectDataList.ResearchProjectDataList[0].research_project_id)

    let obj: any = {
        research_project_id: parseInt(
			data.ResearchProjectDataList.ResearchProjectDataList[0].research_project_id
		),
        nmims_school: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].nmims_school != null
        ? data.ResearchProjectDataList.ResearchProjectDataList[0].nmims_school.map((dt: any) => {
            return { value: dt, label: dt };
        })
        : [],
    nmims_campus: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].nmims_campus != null
        ? data.ResearchProjectDataList.ResearchProjectDataList[0].nmims_campus.map((dt: any) => {
            return { value: dt, label: dt };
        })
        : [],
   
    research_status: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].research_status
        ? { value: data.ResearchProjectDataList.ResearchProjectDataList[0].status_id, label: data.ResearchProjectDataList.ResearchProjectDataList[0].research_status }
        : null,
    title:data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].title? data.ResearchProjectDataList.ResearchProjectDataList[0].title : '',
    ...
    thrust_area: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].thrust_area? data.ResearchProjectDataList.ResearchProjectDataList[0].thrust_area : '',
    funding_amount: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].funding_amount? data.ResearchProjectDataList.ResearchProjectDataList[0].funding_amount : '',
    funding_agency: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].funding_agency? data.ResearchProjectDataList.ResearchProjectDataList[0].funding_agency : '',
    duration: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].duration? data.ResearchProjectDataList.ResearchProjectDataList[0].duration : '',
    scheme: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].scheme? data.ResearchProjectDataList.ResearchProjectDataList[0].scheme : '',
    received_amount: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].received_amount? data.ResearchProjectDataList.ResearchProjectDataList[0].received_amount : '',

    grant_date: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].grant_date? data.ResearchProjectDataList.ResearchProjectDataList[0].grant_date : '',
    payment_date: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].payment_date? data.ResearchProjectDataList.ResearchProjectDataList[0].payment_date : '',
  
    internal_authors: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && facultyDetails.filter((author: any) => author.abbr === 'int').map((author: any) => ({ value: author.id, label: author.faculty_name })),
    external_authors: data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && facultyDetails.filter((author: any) => author.abbr === 'ext').map((author: any) => ({ value: author.id, label: author.faculty_name }))
};



    let grantDate: Date | null = new Date();
    grantDate = data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].grant_date!= null ? new Date(data.ResearchProjectDataList.ResearchProjectDataList[0].grant_date) : null;
    $: grantFormattedDate = grantDate ? formatDate(grantDate) : '';

    let paymentDate: Date | null = new Date();
    paymentDate = data.ResearchProjectDataList.ResearchProjectDataList.length > 0 && data.ResearchProjectDataList.ResearchProjectDataList[0].payment_date!= null ? new Date(data.ResearchProjectDataList.ResearchProjectDataList[0].payment_date) : null;
        ...
        <div class="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="flex flex-row gap-[40px] p-4">
				...
				>
					<div class="text-primary hover:bg-base flex items-center gap-x-3 rounded-lg px-3 py-2">
						<SelectDateIcon />
						<span class="text-body-2 font-bold">Add Annual Payment Date</span>
					</div>
				</DatePicker>
