<script lang="ts">
 ...
 let masterAllAuthors = data?.bookChapterPublicationData?.masterAllAuthors?.message;
 ...
 let obj : any = {
    book_chapter_id: parseInt(data.bookChapterPublicationData.bookChapterPublicationData[0].book_chapter_id),
     nmims_school: data.bookChapterPublicationData.bookChapterPublicationData[0].nmims_school.length > 0
             ? data.bookChapterPublicationData.bookChapterPublicationData[0].nmims_school.map((dt: any) => {
                     return { value: dt, label: dt };
                 })
             : [],
     nmims_campus: data.bookChapterPublicationData.bookChapterPublicationData[0].nmims_campus.length > 0
             ? data.bookChapterPublicationData.bookChapterPublicationData[0].nmims_campus.map((dt: any) => {
                     return { value: dt, label: dt };
                 })
             : [],
     all_authors: data.bookChapterPublicationData.bookChapterPublicationData[0].all_authors.length > 0
             ? data.bookChapterPublicationData.bookChapterPublicationData[0].all_authors.map((dt: any) => {
