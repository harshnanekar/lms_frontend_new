...
<script lang="ts">
    ...
    import { ChroniclesAction, MeetingChronicleAction } from '$lib/components/modules/mpc';
    ...
    let label = 'Meeting Chronicle'
    let dynamicUrl = `${PUBLIC_API_BASE_URL}/chronicle-list-paginate?id=7`;
...
<div class="flex items-center justify-between">
    <Header header={label} />
    <a href="{PUBLIC_BASE_URL}meeting-chronicle/create">
...
<div class="shadow-card mt-[5%] rounded-2xl border-[1px] border-[#E5E9F1] p-2.5 !pt-0 sm:p-6">
	<PaginateDynamic url={$paginateUrl} header={ChronicleHeaders} let:actionData>
		<MeetingChronicleAction {actionData} />
	</PaginateDynamic>
</div>
